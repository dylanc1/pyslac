...
MM_TYPE_NAMES = {
    CM_SET_KEY | MMTYPE_REQ: "CM_SET_KEY.REQ",
    CM_SLAC_PARM | MMTYPE_REQ: "CM_SLAC_PARM.REQ",
    CM_SLAC_PARM | MMTYPE_CNF: "CM_SLAC_PARM.CNF",
    CM_START_ATTEN_CHAR | MMTYPE_IND: "CM_START_ATTEN_CHAR.IND",
    CM_MNBC_SOUND | MMTYPE_IND: "CM_MNBC_SOUND.IND",
    CM_ATTEN_PROFILE | MMTYPE_IND: "CM_ATTEN_PROFILE.IND",
    CM_MNBC_SOUND | MMTYPE_IND: "CM_MNBC_SOUND.IND",
    CM_ATTEN_CHAR | MMTYPE_IND: "CM_ATTEN_CHAR.IND",
    CM_ATTEN_CHAR | MMTYPE_RSP: "CM_ATTEN_CHAR.RSP",
    CM_ECDH_EXCHANGE | MMTYPE_REQ: "CM_ECDH_EXCHANGE.REQ",
    CM_ECDH_EXCHANGE | MMTYPE_RSP: "CM_ECDH_EXCHANGE.RSP",
    CM_SLAC_MATCH | MMTYPE_REQ: "CM_SLAC_MATCH.REQ",
